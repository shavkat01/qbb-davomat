...
function saveProduct() {
    ...
    if (product?.value.name?.trim()) {
        if (product.value.id) {
            ...
            toast.add({ severity: 'success', summary: 'Муваффақиятли', detail: 'Product Updated', life: 3000 });
        } else {
            ...
            toast.add({ severity: 'success', summary: 'Муваффақиятли', detail: 'Product Created', life: 3000 });
        }
...
function deleteProduct() {
    ...
    product.value = {};
    toast.add({ severity: 'success', summary: 'Муваффақиятли', detail: 'Product Deleted', life: 3000 });
}
...
function deleteSelectedProducts() {
    ...
    toast.add({ severity: 'success', summary: 'Муваффақиятли', detail: 'Products Deleted', life: 3000 });
}
